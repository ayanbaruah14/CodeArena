...
export default function Rooms() {
  ...
  const joinRoom = () => {
    if (!roomId.trim()) { setError("ENTER A ROOM ID FIRST"); return; }
    navigate(`/room/${roomId}`);
  };
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 gap-8">
        ...
        <div className="text-center">
          <h1 style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:"3.5rem", letterSpacing:".08em", lineHeight:"0.95" }}>
            <span className="block text-white" style={{ textShadow:"2px 2px 0 rgba(255,45,120,.4)" }}>
              BATTLE
            </span>
            <span className="block" style={{ color:"#ff2d78", textShadow:"0 0 10px #ff2d78,0 0 30px #ff2d7888,0 0 70px #ff2d7833" }}>
              ROOMS
            </span>
          </h1>
        ...
        {user && (
          <div className="flex items-center gap-2 px-4 py-2"
            ...
            <span style={{ fontSize:".52rem", letterSpacing:".15em", color:"rgba(0,245,255,.7)", textTransform:"uppercase" }}>
              LOGGED IN AS
            </span>
            <span style={{ fontSize:".62rem", letterSpacing:".1em", color:"#00f5ff", textShadow:"0 0 8px #00f5ff88" }}>
              {user.username}
            </span>
          </div>
        )}
        ...
        <div className="flex flex-col gap-4 w-full max-w-sm">
          ...
          <div className="p-6 relative overflow-hidden group"
            ...
            <div className="flex items-center gap-3 mb-2">
              ...
              <span style={{ fontFamily:"'Bebas Neue',sans-serif", fontSize:".95rem", letterSpacing:".08em", color:"#fff" }}>
                CREATE A ROOM
              </span>
            </div>
            ...
            <button
              ...
              style={{
                fontFamily:"'Share Tech Mono',monospace", fontSize:".58rem", letterSpacing:".2em",
                textTransform:"uppercase", color:"#00f5ff",
                background:"rgba(0,245,255,.07)", border:"1px solid rgba(0,245,255,.35)",
          ...
          <div className="flex items-center gap-3">
            ...
            <span style={{ fontFamily:"'Share Tech Mono',monospace", fontSize:".48rem", letterSpacing:".3em", color:"rgba(255,45,120,.35)" }}>
              OR
            </span>
            <span className="flex-1 h-px" style={{ background:"rgba(255,45,120,.15)" }} />
          </div>
          ...
          <div className="p-6 relative overflow-hidden group"
            ...
            <div className="flex gap-2">
              <div className="flex-1 relative">
                <input
                  ...
                  style={{
                    ...
                    border:"1px solid rgba(255,45,120,.25)", borderTop:"1px solid rgba(255,45,120,.4)",
                    caretColor:"#ff2d78",
                  }}
              ...
              <button
                ...
                style={{
                  fontFamily:"'Share Tech Mono',monospace", fontSize:".55rem", letterSpacing:".15em",
                  textTransform:"uppercase", color:"#ff2d78",
                  background:"rgba(255,45,120,.08)", border:"1px solid rgba(255,45,120,.35)",
                  borderTop:"2px solid #ff2d78",
                }}
                onMouseEnter={e => e.currentTarget.style.boxShadow="0 0 20px rgba(255,45,120,.25)"}
                onMouseLeave={e => e.currentTarget.style.boxShadow="none"}
              >
                JOIN →
              </button>
        ...
        {error && (
          <div className="flex items-center gap-2 px-4 py-2 animate-pulse"
            style={{ border:"1px solid rgba(255,45,120,.35)", borderLeft:"3px solid #ff2d78", background:"rgba(255,45,120,.07)", fontFamily:"'Share Tech Mono',monospace", fontSize:".52rem", letterSpacing:".12em", color:"#ff2d78" }}>
            <span>⚠</span>
            <span>{error}</span>
          </div>
        )}
